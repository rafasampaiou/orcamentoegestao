...
// é clicável a qualquer momento (não é sequencial) — o usuário pode editar/refazer qualquer etapa
// fora de ordem.
const OtbProgressTimeline: React.FC<OtbProgressTimelineProps> = ({ completed, onStepClick, title }) => {
