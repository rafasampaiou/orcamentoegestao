...
export const lazerRows: BudgetRow[] = [
    ...
    { id: 'lazer_rev_fap', label: 'Receita COM rateios', isInput: true, format: 'integer' },
    { id: 'lazer_rev_hosp', label: 'Receita SEM rateios', isInput: true, format: 'integer' },
...
export const eventRows: BudgetRow[] = [
    ...
    { id: 'event_rev_fap', label: 'Receita COM rateios', isInput: true, format: 'integer' },
    { id: 'event_rev_hosp', label: 'Receita SEM rateios', isInput: true, format: 'integer' },
