...
export const USALI_STRUCTURE = [
    ...
    { code: '4.03.01.01.038', name: 'Despesas Nao Dedutiveis Pequenas Despesas', package: 'Despesas Administrativas', master: 'DESPESAS ADMINISTRATIVAS' },    { code: '4.03.02.01.001', name: 'Divulgacao, anuncio e publicacao', package: 'Despesas com Vendas e Marketing', master: 'DESPESAS COM VENDAS E MARKETING' },
...
export const getForecastData = (
    ...
    rows.push(generateRow('IND-KPI', '', 'Indicators', 'KPI de produtividade', 0, 1.5, 1.4, 0, false, false, 0, undefined, { format: 'decimal' }, 'INDICADORES GERAIS'));
